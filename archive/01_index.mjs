...
// localhost:3000/products?key=id&brand=adidas

// PUT - update data (updates entire resource) You are including every single field in that request body
//       even if not updating it, otherwise these fields will be set as NULL

// PATCH - update data (updates record but updates it partially)
// *but technically different how you update data
// DELETE -
